...
theta2 <- seq(0.0003, 0.0016, 0.0002)
...
for(jj in 1:length(shape2)){
  ...
  allpower_low_all[[jj]] <- allpower_low
  
}



save(allpower_low_all, file = "simu_real_power_low_all_theta.Rdata")
